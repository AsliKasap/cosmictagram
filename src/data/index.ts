...
const data: IData[] = [
  {
    user: {
      nickname: "cosmicWayfarer",
      avatar: "https://www.innovationnewsnetwork.com/wp-content/uploads/2022/09/cosmic-ray-696x392.jpg",
    },
    image: "https://www.elisascience.org/files/styles/keyimage/public/images/M31_Spiral_Galaxy.jpg?itok=Jo_1T4c9",
    description: "Cosmossss",
  },
  {
    user: {
      nickname: "johndoe",
